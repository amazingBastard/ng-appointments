#AngularJS Calendar Appointments Demo

Angular prototype using a calendar with events pulled from a json array.

**Based on John Papa's Angular Style Guide - [Modular Demo](https://github.com/johnpapa/ng-demos/tree/master/modular)**
